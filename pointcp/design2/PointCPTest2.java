 ...
 * returrns both polar and cartesian. Only stores polar.
 *
...
public class PointCPTest2
{
  ...
  public static void main(String[] args)
  {
    ...
    //Returns stored polar coordinate and returns calculated cartesian coordinates.
  ...
  private static PointCP2 getInput() throws IOException
  {
    ...
    for (int i = 0; i < 2; i++)
    {
        while (!(isOK))
        {
            ...
            (i == 0 ? "Rho " : "Theta ") + "using a decimal point(.): ");
